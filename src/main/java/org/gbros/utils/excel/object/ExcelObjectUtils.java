...
public class ExcelObjectUtils {
	 ...
	 * @return 
	 */
	private static ExcelObject toExcelObject(Workbook wbs,String fileName)throws Exception{
	...
	public static ExcelObject toExcelObject(String excelName,List<SheetObject> sheetList){
		ExcelObject excel = new ExcelObject();
