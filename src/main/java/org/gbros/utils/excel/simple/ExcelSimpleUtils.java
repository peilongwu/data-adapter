...
public class ExcelSimpleUtils {
	 ...
	 * @return 
	 */
	public static JSONObject toJSONObject(InputStream inputStream, String fileName)throws Exception {
		Workbook wbs = null;
	 ...
	 * @return 
	 */
	public static ExcelSimple toExcelSimple(InputStream inputStream, String fileName)throws Exception {
		Workbook wbs = null;
		if(fileName.contains("xlsx")) {
			wbs = new XSSFWorkbook(inputStream);
		}else if(fileName.contains("xls")){
	...
	public static String toJSONP(String callBackName,InputStream inputStream, String fileName) throws Exception{
	 ...
	 * @return 
	 */
	private static JSONObject toJSONObject(Workbook wbs,String fileName)throws Exception{
	 ...
	 * @return 
	 */
	private static ExcelSimple toExcelSimple(Workbook wbs,String fileName)throws Exception{
