...
public class ExcelReader implements IReader{
	...
	@Override
	public JSONObject getList(String excelName, String sheetName, Map<String,Object> filter)
			throws Exception {
		JSONArray array = ExcelObjectUtils.toJSONArray(BASE_DIR+excelName, sheetName);
		...
		rowset.getJSONObject("Rowsets").getJSONObject("Rowset").put("Row", returnArray);
		return rowset;
	}
